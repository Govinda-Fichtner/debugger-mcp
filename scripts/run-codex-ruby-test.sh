...
**Note**: Line 5 is the first if statement in the fizzbuzz method
...
6. \`debugger_set_breakpoint\` (file "/workspace/tests/fixtures/fizzbuzz.rb", line 5): <describe result>
...
**Why**: Line 5 is the first condition in fizzbuzz method.
...
\`\`\`
**Expected**: Array of frames, top frame at fizzbuzz.rb:5
