...
/// Cargo test wrapper for Ruby Codex integration test
///
/// This wrapper invokes the shell script and validates output for code coverage.
#[tokio::test]
#[ignore]
async fn test_ruby_codex_via_script() {
    println!("\n🚀 Ruby Codex Integration Test (via script)");
    println!("═══════════════════════════════════════════");
    ...
    println!("✅ Ruby Codex test completed");
}
