...
/// Cargo test wrapper for Python Codex integration test
///
/// This wrapper invokes the shell script and validates output for code coverage.
#[tokio::test]
#[ignore]
async fn test_python_codex_via_script() {
    println!("\n🚀 Python Codex Integration Test (via script)");
    println!("═══════════════════════════════════════════════");
    ...
    println!("✅ Python Codex test completed");
}
